      ...
      <div className="flex flex-wrap justify-evenly">
        {alumniList.map((alumni) => (
          <motion.div
            ...
            className="m-[2%] w-[45%] min-w-80 bg-gradient-to-r from-blue-50to-cyan-50 h-70 rounded-2xl flex flex-wrap flex-col gap-2 justify-evenly shadow-[5px 5px 15px] border-2 hover:shadow-[0px 10px 24px rgba(142, 68, 173, 0.4)] hover:scale-[1.03] hover:border-[#9b59b6]
