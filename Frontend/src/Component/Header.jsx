        ...
        <div className="flex justify-between h-16 items-center">
         ...
         transition-transform duration-300 ease-in-out ... hover:scale-105 hover:shadow-lg max-[320px]:text-base">Bio-Computational Lab</div>
          ...
          <nav className=" hidden lg:flex space-x-8 text-xl leading-7 items-center">
            <NavLink to="/Home" className={({ isActive }) => `no-underline text-xl hover:text-cyan-600 hover:drop-shadow-[0_6px_6px_rgba(3,245,249,0.8)] ${isActive ? "text-cyan-600  " : "text-[#551A8B]"
              }`}> Home</NavLink>
            ...
            <NavLink to="/Research" className={({ isActive }) => `no-underline text-xl hover:text-cyan-600 hover:drop-shadow-[0_6px_6px_rgba(3,245,249,0.8)] ${isActive ? "text-cyan-600  " : "text-[#551A8B]"
              }`}> Research</NavLink>
            <NavLink to="/Event" className={({ isActive }) => `no-underline text-xl hover:text-cyan-600 hover:drop-shadow-[0_6px_6px_rgba(3,245,249,0.8)] ${isActive ? "text-cyan-600  " : "text-[#551A8B]"
              }`}> Event</NavLink>
            <NavLink to="/Project" className={({ isActive }) => `no-underline text-xl hover:text-cyan-600 hover:drop-shadow-[0_6px_6px_rgba(3,245,249,0.8)] ${isActive ? "text-cyan-600  " : "text-[#551A8B]"
              }`}> Project</NavLink>
            <NavLink to="/contact" className={({ isActive }) => `no-underline text-xl hover:text-cyan-600 hover:drop-shadow-[0_6px_6px_rgba(3,245,249,0.8)] ${isActive ? "text-cyan-600  " : "text-[#551A8B]"
              }`}> Contact Us</NavLink>
           ...
           active:bg-blue-500">Admin</button>
            </div>
          </nav>
          ...
          <div className="lg:hidden flex items-center space-x-2">
           ...
           active:bg-blue-400 max-[400px]:hidden">Admin</button>
